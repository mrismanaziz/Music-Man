...
@Client.on_message(
    filters.command("start") & filters.private & ~filters.edited)
...
┣• Mendownload Lagu.
┣• Teman tidur di OS.
┣• Klik » /help « untuk Mengetahui Fitur Lengkap saya
┗━━━━━━━━━━━━━━
...
Ingin Menambahkan Saya ke Grup Anda? Tambahkan Saya Ke Group Anda!
        ...
        reply_markup=InlineKeyboardMarkup([
            ...
            [
                InlineKeyboardButton("💬 Channel Updates",
...
def map(pos):
    if pos == 1:
        return [[InlineKeyboardButton(text="Next »", callback_data="help+2")]]
        ...
        return [
            ...
            [
                ...
                InlineKeyboardButton(text="⛑ Group Support",
                                     url=f"https://t.me/{SUPPORT_GROUP}"),
            ],
            [
...
@Client.on_message(
    filters.command("help") & ~filters.private & ~filters.channel)
